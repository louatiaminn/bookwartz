...
");
$stmt->execute();
$history_books = $stmt->fetchAll(PDO::FETCH_ASSOC);

// NEW: Add recommendation function from anime.php
...
// NEW: Handle recommendation requests
...
// NEW: Handle finding book ID for recommendations
...
<head>
    ...
    <title>BookWartz - History</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="https://unpkg.com/swiper/swiper-bundle.min.css" />
    <link rel="stylesheet" href="../assets/style.css">
    <!-- NEW: Add recommendation system styles -->
    <style>
...
<body>
<div class="banner banner-history">
    ...
    <div class="hero-section text-center bg-light py-5">
        <h1>History Books</h1>
        <p>Delve into the past with these compelling history books.</p>
    </div>

    <div class="container my-5">
        <div class="row g-4">
            <?php if ($history_books): ?>
                <?php foreach ($history_books as $index => $book): ?>
                <div class="col-md-4">
                    <div class="card h-100 shadow">
                        ...
                        <div class="card-body">
                            ...
                            <!-- UPDATED: Add recommendation button and flex wrap -->
            ...
            <?php else: ?>
                <div class="col-12 text-center pt-4">
                    <p>No History books available at the moment. Check back later!</p>
                </div>
            <?php endif; ?>
        </div>
    </div>
    ...
    <!-- NEW: Add all recommendation JavaScript functions -->
    <script>
        function getRecommendations(bookTitle) {
