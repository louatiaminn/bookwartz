...
");
$stmt->execute();
$nonfiction_books = $stmt->fetchAll(PDO::FETCH_ASSOC);
...
<head>
    ...
    <title>BookWartz - New Arrival</title>
...
<body>
<div class="banner banner-nonfiction">
    ...
    <div class="hero-section text-center bg-light py-5">
            ...
            <p>Discover an array of inspiring non-fiction books.</p>
        </div>
 
        <div class="container my-5">
            <div class="row g-4">
                <?php if ($nonfiction_books): ?>
                    <?php foreach ($nonfiction_books as $index => $book): ?>
                    <div class="col-md-4">
                        <div class="card h-100 shadow">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex flex-wrap gap-2">
                                    ...
                                    <form action="nonfiction.php" method="POST" class="d-inline">
                ...
                <?php else: ?>
                    <div class="col-12 text-center pt-4">
                        <p>No Non-Fiction books available at the moment. Check back later!</p>
                    </div>
                <?php endif; ?>
