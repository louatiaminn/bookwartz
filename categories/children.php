...
");
$stmt->execute();
$children_books = $stmt->fetchAll(PDO::FETCH_ASSOC);

// ADD: Recommendation system function
...
// ADD: Handle recommendation requests
...
// ADD: Handle finding book ID for recommended books
...
<head>
    ...
    <title>BookWartz - Children</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="https://unpkg.com/swiper/swiper-bundle.min.css" />
    <link rel="stylesheet" href="../assets/style.css">
    <!-- ADD: Recommendation system styles -->
    <style>
...
<div class="banner banner-children">
    <nav class="navbar navbar-expand-lg" style="border-radius: 8px;">
        <div class="container-fluid col-md-12">
            ...
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarContent" aria-controls="navbarContent" aria-expanded="false" aria-label="Toggle navigation" style="border: none; border-radius: 5px;">
            ...
            <div class="collapse navbar-collapse" id="navbarContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="categoriesDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false" style="color: white;">Categories</a>
                    ...
                    <li class="nav-item"><a class="nav-link" href="../controllers/cart.php" style="color: white;">Cart</a></li>
                    <li class="nav-item">
    ...
    <div class="hero-section text-center bg-light py-5">
        ...
        <p>Explore the world of children with these books.</p>
    </div>

    <div class="container my-5">
        <div class="row g-4">
            <?php if ($children_books): ?>
                <?php foreach ($children_books as $index => $book): ?>
                <div class="col-md-4">
                    <div class="card h-100 shadow">
                        ...
                        <div class="card-body">
                            ...
                            <!-- ADD: Updated button section with recommendation button -->
                            <div class="d-flex flex-wrap gap-2">
                                ...
                                <form action="children.php" method="POST" class="d-inline">
            ...
            <?php else: ?>
                <div class="col-12 text-center pt-4">
                    <br>
                    <p>No children books available at the moment. Check back later!</p>
                </div>
            <?php endif; ?>
        </div>
    </div>
    ...
    <!-- ADD: Recommendation system JavaScript -->
    <script>
        function getRecommendations(bookTitle) {
