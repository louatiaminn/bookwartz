...
// HANDLE RECOMMENDATION REQUESTS - Added from anime.php
...
// FIND BOOK ID FOR RECOMMENDED BOOKS - Added from anime.php
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_to_cart'])) {
    if (!isset($_SESSION['user_id'])) {
        ...
        header("Location: ../controllers/login.php"); // Updated path like in anime.php
        exit();
    }
    ...
    if (!$book) {
        ...
        header("Location: mostpopular.php");
        exit();
    }
...
<head>
    ...
    <title>BookWartz - Most Popular</title>
...
<body>
<div class="banner banner-popular">
    ...
    <div class="hero-section text-center bg-light py-5">
        ...
        <p>Browse through our collection of the most popular books this season.</p>
    </div>
        ...
        <div class="row g-4">
                ...
                <div class="col-md-4">
                    <div class="card h-100 shadow">
                        ...
                        <div class="card-body">
                            ...
                            <!-- UPDATED BUTTON LAYOUT WITH RECOMMENDATIONS - Modified from anime.php -->
                            <div class="d-flex flex-wrap gap-2">
                                ...
                                <form action="mostpopular.php" method="POST" class="d-inline">
            ...
            <?php else: ?>
                <div class="col-12 text-center pt-4">
                    <p>No Most Popular books available at the moment. Check back later!</p>
                </div>
            <?php endif; ?>
        </div>
    </div>

    <!-- RECOMMENDATION SECTION - Added from anime.php -->
    <div class="container my-5">
    ...
    <!-- RECOMMENDATION SYSTEM JAVASCRIPT - Added from anime.php -->
    <script>
        function getRecommendations(bookTitle) {
