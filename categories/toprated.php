...
");
$stmt->execute();
$toprated_books = $stmt->fetchAll(PDO::FETCH_ASSOC);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_to_cart'])) {
    ...
    if (!$book) {
        ...
        header("Location: ../categories/toprated.php"); 
        exit();
    }
...
<head>
    ...
    <title>BookWartz - Top Rated</title>
...
<body>
<div class="banner banner-toprated">
    ...
    <div class="hero-section text-center bg-light py-5">
        ...
        <p>Discover the Top Rated Books of all times</p>
    </div>

    <div class="container my-5">
        <div class="row g-4">
            <?php if ($toprated_books): ?>
                <?php foreach ($toprated_books as $index => $book): ?>
                <div class="col-md-4">
                    <div class="card h-100 shadow">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-wrap gap-2">
                                ...
                                <form action="toprated.php" method="POST" class="d-inline">
            ...
            <?php else: ?>
                <div class="col-12 text-center pt-4">
                    <p>No Top Rated books available at the moment. Check back later!</p>
                </div>
            <?php endif; ?>
        </div>
    </div>
