...
");
$stmt->execute();
$science_books = $stmt->fetchAll(PDO::FETCH_ASSOC);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_to_cart'])) {
    ...
    if (!$book) {
        ...
        header("Location: science.php"); // Redirect back to the science page
        exit();
    }
...
<head>
  ...
  <link rel="stylesheet" href="../assets/style.css">
    ...
    <body>
    <div class="banner banner-science">
        ...
        <h1>Science Books</h1>
        <p>Explore the world of science with these captivating books.</p>
    </div>

    <div class="container my-5">
        <div class="row g-4">
            <?php if ($science_books): ?>
                <?php foreach ($science_books as $index => $book): ?>
                <div class="col-md-4">
                    <div class="card h-100 shadow">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex">
                                ...
                                <form action="mostpopular.php" method="POST">
            ...
            <?php else: ?>
                <div class="col-12 text-center pt-4">
                    <p>No science books available at the moment. Check back later!</p>
                </div>
            <?php endif; ?>
        </div>
    </div>
