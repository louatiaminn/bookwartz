...
");
$stmt->execute();
$newarr_books = $stmt->fetchAll(PDO::FETCH_ASSOC);
...
<body>
<div class="banner banner-newarrival">
    ...
    <div class="container my-5">
        <div class="row g-4">
            <?php if ($newarr_books): ?>
                <?php foreach ($newarr_books as $index => $book): ?>
                <div class="col-md-4">
                    <div class="card h-100 shadow">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-wrap gap-2">
                                ...
                                <form action="newArrival.php" method="POST" class="d-inline">
